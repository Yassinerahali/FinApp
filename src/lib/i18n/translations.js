...
export const TRANSLATIONS = {
  en: {
    ...
    assistantGreeting: "Hi! I can help you plan a savings goal, keep an eye on your budgets, or answer questions about your spending. What's on your mind?",
    assistantCloseAria: "Close assistant",
    assistantOpenAria: "Open assistant",
  ...
  fr: {
    ...
    assistantTitle: "Assistant",
    assistantGreeting: "Bonjour ! Je peux vous aider à planifier un objectif d'épargne, surveiller vos budgets, ou répondre à des questions sur vos dépenses. Que puis-je faire pour vous ?",
    assistantCloseAria: "Fermer l'assistant",
    assistantOpenAria: "Ouvrir l'assistant",
  ...
  ar: {
    ...
    assistantGreeting: "مرحبًا! يمكنني مساعدتك في التخطيط لهدف ادخار، أو متابعة ميزانياتك، أو الإجابة عن أسئلة حول إنفاقك. بم يمكنني مساعدتك؟",
    assistantCloseAria: "إغلاق المساعد",
    assistantOpenAria: "فتح المساعد",
